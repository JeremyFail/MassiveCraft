![MassiveHat Logo](https://factions.wiki/MassiveBooks/img/hero.png)
...
Please visit the [Main Releases Page](https://github.com/JeremyFail/MassiveCraft/releases) (in my MassiveCraft mono-repository) and download the latest version, as well as MassiveCore, the dependency library required to run MassiveBooks on your Spigot/Paper Minecraft Server. Drop both in your plugins folder and restart your server.
