...
//    }
    ...
    @Override
    public Faction autoClaim()
    {
        return getAutoClaimFor();
    }
    ...
    @Override
    public void autoClaim(Faction faction)
    {
        setAutoClaimFor(faction);
    }
    ...
    @Override
    public Faction autoUnclaim()
    {
        return getAutoUnclaimFor();
    }
    ...
    @Override
    public void autoUnclaim(Faction faction)
    {
        setAutoUnclaimFor(faction);
    }
    ...
    @Override
    public void adminBypass(boolean adminBypassing)
    {
        setIsAdminBypassing(adminBypassing);
    }
    ...
    @Override
    public void power(double delta)
    {
        alterPower(delta);
    }
