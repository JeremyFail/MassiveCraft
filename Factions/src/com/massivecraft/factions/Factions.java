...
import com.massivecraft.factions.entity.migrator.MigratorFaction006VehiclesAndLecternsPerm;
import com.massivecraft.factions.entity.migrator.MigratorFaction007CushionPerm;
...
import com.massivecraft.factions.integration.map.bluemap.IntegrationBlueMap;
import com.massivecraft.factions.integration.map.dynmap.IntegrationDynmap;
...
public class Factions extends MassivePlugin
{
	...
	public List<Class<?>> getClassesActiveMigrators()
	{
		return MUtil.list(
			...
			MigratorFaction006VehiclesAndLecternsPerm.class,
			MigratorFaction007CushionPerm.class,
