...
public class MPerm extends Entity<MPerm> implements Prioritized, Registerable, Named
{
	...
	public final static transient String ID_CUSHION = "cushion";
	...
	public final static transient int PRIORITY_CUSHION = 2600;
	...
	public final static transient int PRIORITY_LECTERN = 6200;
	...
	public static MPerm getPermLectern() { return getCreative(PRIORITY_LECTERN, ID_LECTERN, ID_LECTERN, "take books from lecterns", true, true, true); }
