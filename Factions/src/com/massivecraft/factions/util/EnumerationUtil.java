...
public class EnumerationUtil
{
    ...
    // Interacting with these materials placed in the terrain results in door
    // toggling.
    ...
    {
        return ENTITY_TYPES_EDIT_ON_DAMAGE.contains(entityType)
                || MConf.get().entityTypesEditOnDamage.contains(entityType);
    }
