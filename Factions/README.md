...
Please visit the [MassiveCraft Releases Page](https://github.com/JeremyFail/MassiveCraft/releases) and download the latest version, as well as MassiveCore, the dependency library required to run Factions on your Spigot/Paper Minecraft Server. Drop both in your plugins folder and restart your server.
